...
export const Tag = (prop: TagProps) => {
  ...
  return (
    <>
      ...
      {type === 'relevance' &&
        <div
          className="inline-flex items-center justify-center bg-merino p-[5px] h-[19px] text-nero uppercase leading-[120%] tracking-[0.36px] border-solid border-nero border-[1px] w-min"
          style={{
            fontSize: '14px',
            lineHeight: '120%',
            letterSpacing: '0.36px',
