        ...
        <>
            ...
            {type === "relevance" && (
                <div
                    ...
                    //   whiteSpace: 'nowrap'
                    // }}
                    className={`flex justify-center items-center  bg-merino  tracking-wider  uppercase  text-[17px] border-nero font-bold border-[1px] text-nowrap ${neueBit.className}`}
                >
